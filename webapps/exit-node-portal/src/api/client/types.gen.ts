...
export type ClientOptions = {
    baseUrl: 'http://localhost:33080' | (string & {});
};
 ...
 */
export type ProtocolDiscoveryResponse = {
    /**
     ...
     */
    transports: Array<TransportEndpoint>;
    /**
 ...
 */
export type TransportProtocol = 'quic' | 'websocket' | 'h2';
...
export type ServeAcmeChallengeData = {
    body?: never;
    path: {
        /**
...
export type ServeAcmeChallengeErrors = {
    /**
     * Challenge not found
     */
    404: unknown;
...
export type ServeAcmeChallengeResponses = {
    /**
     * Key authorization
     */
    200: unknown;
...
export type ProtocolDiscoveryData = {
    body?: never;
    path?: never;
    query?: never;
...
export type ProtocolDiscoveryResponses = {
    /**
     * Protocol discovery response
     */
    200: ProtocolDiscoveryResponse;
    /**
     * Protocol discovery not configured
     */
    204: void;
};

export type ProtocolDiscoveryResponse2 = ProtocolDiscoveryResponses[keyof ProtocolDiscoveryResponses];
...
export type GetDomainByIdError = GetDomainByIdErrors[keyof GetDomainByIdErrors];
...
export type RequestAcmeCertificateData = {
    body?: never;
    path: {
        /**
...
export type RequestAcmeCertificateErrors = {
    /**
     * Invalid domain
     */
    400: ErrorResponse;
...
export type RequestAcmeCertificateError = RequestAcmeCertificateErrors[keyof RequestAcmeCertificateErrors];

export type RequestAcmeCertificateResponses = {
    /**
...
export type RequestAcmeCertificateResponse = RequestAcmeCertificateResponses[keyof RequestAcmeCertificateResponses];
...
export type CancelChallengeError = CancelChallengeErrors[keyof CancelChallengeErrors];
...
export type RestartChallengeData = {
    body: InitiateChallengeRequest;
    path: {
        /**
         * Domain name
...
export type RestartChallengeErrors = {
    /**
     * ACME not configured
     */
    503: ErrorResponse;
...
export type RestartChallengeError = RestartChallengeErrors[keyof RestartChallengeErrors];

export type RestartChallengeResponses = {
    /**
...
export type RestartChallengeResponse = RestartChallengeResponses[keyof RestartChallengeResponses];

export type GetDomainChallengesData = {
    body?: never;
    path: {
        /**
         * Domain name
...
export type GetDomainChallengesErrors = {
    /**
     * No challenges found
     */
    404: unknown;
...
export type GetDomainChallengesResponses = {
    /**
     * List of pending challenges
     */
    200: Array<InitiateChallengeResponse>;
};

export type GetDomainChallengesResponse = GetDomainChallengesResponses[keyof GetDomainChallengesResponses];
