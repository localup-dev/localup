        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(string_null(CapturedRequest::Host))
                    ...
                    .col(timestamp_with_time_zone(CapturedRequest::CreatedAt))
                    .col(timestamp_with_time_zone_null(CapturedRequest::RespondedAt))
