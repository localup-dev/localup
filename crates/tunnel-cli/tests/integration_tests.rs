...
#[test]
fn test_tunnel_store_create() {
    let (store, _temp) = create_test_store();
    assert!(store.base_dir().exists());
}

#[test]
fn test_tunnel_store_save_and_load() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_list_empty() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_list_multiple() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_list_enabled() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_enable_disable() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_remove_nonexistent() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_invalid_names() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_valid_names() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_protocol_types() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_exit_node_configs() {
    let (store, _temp) = create_test_store();
...
#[test]
fn test_tunnel_store_serialization_roundtrip() {
    let (store, _temp) = create_test_store();
