...
impl JwtClaims {
    ...
    ///
    /// assert!(claims.validate_reverse_tunnel_access("agent-1", "192.168.1.100:8080").is_ok());
    ///
    ...
    ///
    /// assert!(claims.validate_reverse_tunnel_access("agent-1", "192.168.1.100:8080").is_ok());
    /// assert!(claims.validate_reverse_tunnel_access("agent-2", "192.168.1.100:8080").is_err());
    /// assert!(claims.validate_reverse_tunnel_access("agent-1", "192.168.1.200:8080").is_err());
    /// ```
    pub fn validate_reverse_tunnel_access(
        &self,
        agent_id: &str,
        remote_address: &str,
    ) -> Result<(), String> {
...
mod tests {
    ...
    #[test]
    fn test_reverse_tunnel_permissive_token() {
        // Permissive token - all reverse tunnels allowed
        let claims = JwtClaims::new(
            "client-1".to_string(),
            "issuer".to_string(),
        ...
        assert!(claims
            .validate_reverse_tunnel_access("agent-1", "192.168.1.100:8080")
            .is_ok());
        assert!(claims
            .validate_reverse_tunnel_access("agent-2", "10.0.0.5:22")
            .is_ok());
        assert!(claims
            .validate_reverse_tunnel_access("any-agent", "any-host:9999")
            .is_ok());
    }

    #[test]
    fn test_reverse_tunnel_restrictive_agent() {
        ...
        // Disallowed agent
        let result = claims.validate_reverse_tunnel_access("agent-3", "192.168.1.100:8080");
        assert!(result.is_err());
        assert!(result
            .unwrap_err()
    ...
    #[test]
    fn test_reverse_tunnel_restrictive_address() {
        ...
        // Disallowed address
        let result = claims.validate_reverse_tunnel_access("agent-1", "192.168.1.200:8080");
        assert!(result.is_err());
        assert!(result
            .unwrap_err()
    ...
    #[test]
    fn test_reverse_tunnel_fully_restrictive() {
        ...
        // Invalid: wrong agent
        assert!(claims
            .validate_reverse_tunnel_access("agent-2", "192.168.1.100:8080")
            .is_err());

        // Invalid: wrong address
        assert!(claims
            .validate_reverse_tunnel_access("agent-1", "10.0.0.5:22")
            .is_err());
    ...
    #[test]
    fn test_reverse_tunnel_explicitly_disabled() {
        ...
        let result = claims.validate_reverse_tunnel_access("agent-1", "192.168.1.100:8080");
        assert!(result.is_err());
        assert!(result
            .unwrap_err()
    ...
    #[test]
    fn test_reverse_tunnel_backward_compatibility() {
    ...
    #[test]
    fn test_reverse_tunnel_empty_restrictions() {
        ...
        assert!(claims
            .validate_reverse_tunnel_access("any-agent", "any-address:1234")
            .is_ok());
    }

    #[test]
    fn test_reverse_tunnel_encode_decode_with_restrictions() {
    ...
    #[test]
    fn test_reverse_tunnel_skip_serialization_when_none() {
