...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(CapturedTcpConnection::TunnelId)
                            .string()
                            .not_null(),
                    )
                    .col(
        ...
        // Create index on tunnel_id for filtering
        manager
            .create_index(
                Index::create()
                    .if_not_exists()
                    .name("idx_captured_tcp_connections_tunnel_id")
                    .table(CapturedTcpConnection::Table)
                    .col(CapturedTcpConnection::TunnelId)
                    .to_owned(),
            )
            .await?;
