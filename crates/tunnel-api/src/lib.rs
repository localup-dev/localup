...
impl ApiServer {
    ...
    pub fn new(
        ...
        let state = Arc::new(AppState { tunnel_manager, db });
    ...
    fn build_router(&self) -> Router {
        ...
        let api_router = Router::new()
            ...
            .route(
                ...
                get(handlers::get_tunnel_metrics),
            )
...
pub async fn run_api_server(
    ...
    let server = ApiServer::new(config, tunnel_manager, db);
    server.start().await
}
