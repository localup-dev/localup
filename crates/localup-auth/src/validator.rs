...
impl AuthResult {
    ...
    pub fn new(localup_id: String) -> Self {
        Self {
            localup_id,
            user_id: None,
...
///
/// ```ignore
/// use localup_auth::{AuthValidator, AuthResult, AuthError};
/// use async_trait::async_trait;
///
/// struct ApiKeyValidator {
///     valid_keys: HashMap<String, String>, // api_key -> localup_id
/// }
///
/// #[async_trait]
...
mod tests {
    ...
    fn test_auth_result_builder() {
        let result = AuthResult::new("localup-123".to_string())
        ...
        assert_eq!(result.localup_id, "localup-123");
